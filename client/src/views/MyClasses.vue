...
const handleSubmit = (responseData)=> {
    ...
    toast.add({severity: 'success', summary: 'Sucsess', detail: 'New course created successfully', life: 3000})
    toggleDialog();
}
...
<style scoped></style>
<template>
     <Dialog v-model:visible="openAddCourseDialog" modal :style="{ width: '50rem' }" header="Create course">
