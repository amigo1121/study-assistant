...
onBeforeMount(async () => {
  ...
  try {
    const response = await axios(
      API_URL + `/course/code/${courseCode}`,
      config
    );
...
const addAssignment = (data) => {
  ...
  axios
    .post(API_URL + "/assignments", data, config)
    .then((response) => {
...
const deleteAssignment = (id: number) => {
  ...
  axios
    .delete(API_URL + "/assignments/" + id, config)
    .then((response) => {
      console.log("delete Assignment", response.data);
      const deletedIndex = assignments.value.findIndex(
...
const updateAssignment = (assignmentUpdateInfo) => {
  ...
  axios
    .put(API_URL + "/assignments", assignmentUpdateInfo, config)
    .then((response) => {
      console.log("update", response.data);
      const updatedAssignment = response.data;
      const updateIndex = assignments.value.findIndex(
